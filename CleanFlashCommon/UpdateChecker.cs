...
namespace CleanFlashCommon
{
    ...
    {
        private static readonly string FLASH_VERSION = "32.0.0.465";
        private static readonly string VERSION = "v32.0.0.465";
        private static readonly string FLASH_PLAYER_EXECUTABLE = "flashplayer_32_sa.exe";
